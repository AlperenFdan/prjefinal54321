...
{
    [MangerLoginControl]
    public class MotherboardForMangerController : Controller
    {
        // GET: ManagerPanel/MotherboardForManger
        ...
        public ActionResult Edit(int? id)
        {
            ...
            Motherboard gc = db.Motherboards.Find(id);
            if (gc == null)
            {
        ...
        [HttpPost]
        public ActionResult Edit(int id, Motherboard gr, HttpPostedFileBase hpf)
        {
        ...
        [HttpPost]
        public ActionResult Create(Motherboard model, HttpPostedFileBase hpf)
        {
            try
            {
        ...
        {
            Motherboard model = db.Motherboards.Find(id);
            if (model == null)
            {
                return RedirectToAction("Index");
            }
        ...
        {
            Motherboard md = db.Motherboards.Find(id);
            if (md != null)
            {
                db.Motherboards.Remove(md); db.SaveChanges();
            }
