...
{
    [MangerLoginControl]
    public class StoragesForManagerController : Controller
    {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            Storage gc = db.Storages.Find(id);
            if (gc == null)
            {
        ...
        [HttpPost]
        public ActionResult Edit(int id, Storage gr, HttpPostedFileBase hpf)
        {
        ...
        [HttpPost]
        public ActionResult Create(Storage model, HttpPostedFileBase hpf)
        {
            try
            {
        ...
        {
            Storage model = db.Storages.Find(id);
            if (model == null)
            {
                return RedirectToAction("Index");
            }
        ...
        {
            Storage md = db.Storages.Find(id);
            if (md != null)
            {
                db.Storages.Remove(md); db.SaveChanges();
            }
